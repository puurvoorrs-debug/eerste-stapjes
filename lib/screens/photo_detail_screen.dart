...
class PhotoDetailScreen extends StatefulWidget {
  ...
  const PhotoDetailScreen({super.key, required this.profileId, required this.date});
...
class _PhotoDetailScreenState extends State<PhotoDetailScreen> {
  ...
  void _postComment() {
    ...
    provider.addComment(widget.profileId, widget.date, _commentController.text.trim());
    _commentController.clear();
    FocusScope.of(context).unfocus(); // Verberg het toetsenbord
  }
                        ...
                        children: [
                          if (_currentUser != null)
                            IconButton(
                              ...
                              onPressed: () => Provider.of<ProfileProvider>(context, listen: false).toggleFavorite(widget.profileId, widget.date),
                            ),
                          if (_currentUser != null)
                             IconButton(
                              icon: Icon(
                              ...
                              onPressed: () => Provider.of<ProfileProvider>(context, listen: false).toggleLike(widget.profileId, widget.date),
                            ),
